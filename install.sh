#!/usr/bin/env sh
# Universal installer for certpatrol. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/certpatrol.git"
echo "Installing certpatrol ..."
